...
def create_app(test_config=None):
    ...
    * SECRET_KEY The secret key Flask uses for sessions. Change this temporary value
    ...
    #cors = CORS(app, supports_credentials=True, origins="https://"+os.environ["SHIPYARD_DOMAIN"])
    ...
    if app.config.get("TESTING"):
        ...
        dynamodb_resource = boto3.resource("dynamodb", endpoint_url=endpoint_url, region_name="us-east-1", aws_access_key_id=ACCESS_ID, aws_secret_access_key= ACCESS_KEY)
        ses_client = boto3.client("ses", endpoint_url=endpoint_url, region_name="us-east-1", aws_access_key_id=ACCESS_ID, aws_secret_access_key= ACCESS_KEY)
